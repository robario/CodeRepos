...
# $Id$
#
package Plagger::Plugin::Acme::CustomConfig::ReadLine;
use strict;
use warnings;
use utf8;
...
Plagger::Plugin::Acme::CustomConfig::ReadLine - Acme::CustomConfig plugin

=head1 VERSION

This document describes Plagger::Plugin::Acme::CustomConfig::ReadLine version 0.0.1
...
Plagger::Plugin::Acme::CustomConfig::ReadLine requires no configuration files or environment variables.
